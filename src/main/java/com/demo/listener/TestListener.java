...
public class TestListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		if (islogIssue) {
			JiraServiceProvider JiraServiceProvider = new JiraServiceProvider("https://instance.atlassian.net",
					"examplex@gmail.com", "7ADVGyjJqAxk2srerereu3923", "TNG");
			...
			JiraServiceProvider.createJiraIssue("Bug", issueSummary, issueDescription, "High", "2022-07-31", "Selenium-Automation");
		}
	}
	@Override
